...
class Veterinarian(models.Model):
    ...
    regular_checkup_fee = models.IntegerField(default=1000)
    vaccination_fee = models.IntegerField(default=1500)
    emergency_fee = models.IntegerField(default=2000)
    followup_fee = models.IntegerField(default=800)
