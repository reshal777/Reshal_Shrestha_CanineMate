...
urlpatterns = [
    ...
    path('adoption-success/<int:request_id>/', views.adoption_success_view, name='adoption_success'),
    ...
    path('review/delete/<int:review_id>/', views.delete_product_review, name='delete_product_review'),
    ...
    path('api/profile/delete/', views.delete_user_account_api, name='delete_user_account_api'),
